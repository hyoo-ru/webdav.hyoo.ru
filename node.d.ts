...
declare namespace $ {
    class $hyoo_webdav extends $mol_book {
        ...
        title(): string;
        title_root(): string;
        Folder(folder: any): $$.$hyoo_webdav_folder;
        ...
        File(file: any): $hyoo_webdav_file;
...
declare namespace $.$$ {
    class $hyoo_webdav extends $.$hyoo_webdav {
        render(): void;
        pages(): ($hyoo_webdav_folder | $hyoo_webdav_file)[];
        ...
        folder_row_title(uri: string): string | null;
        folder_row_descr(uri: string): string;
        file_uri(uri: string): string;
        file_mime(uri: string): string | null;
